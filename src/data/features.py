...
FS: float = 2048.0          # samplig rate (Hz)
...
def compute_features(sample: np.ndarray) -> np.ndarray:
    ...
    1. Extract RAW amplitude features first (signal strength indicators)
    2. Then normalize and extract SHAPE features (correlations, frequency distribution)
    ...
    # =====================================================================
    # PART 1: RAW AMPLITUDE FEATURES (signal strength - BEFORE normalization)
    # =====================================================================

    # Raw statistics per detector - these capture signal STRENGTH
    ...
    # 9 features so far (3 detectors × 3 features)
    ...
    # =====================================================================
    # PART 2: NORMALIZED SHAPE FEATURES (signal shape - AFTER normalization)
    # =====================================================================
